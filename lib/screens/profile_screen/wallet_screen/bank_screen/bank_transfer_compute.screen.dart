  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'Bank Transfer',
          style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white), // Made title white for better contrast
        ),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(widget.account, style: TextStyle(color: Colors.grey)),
                    ],
                  )
                ],
              ),
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF800000), // pure maroon
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12),
                    ),
                  ),
                  child: Text('Transfer', style: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              ),
            )
          ],
