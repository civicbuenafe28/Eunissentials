...
class EWalletComputeScreen extends StatefulWidget {
  final String username;
  final String contact;
  final String wallet;

  const EWalletComputeScreen({
  ...
  @override
  _EWalletComputeScreenState createState() => _EWalletComputeScreenState();
}

class _EWalletComputeScreenState extends State<EWalletComputeScreen> {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Wallet: ${widget.wallet}', style: TextStyle(color: Colors.black54, fontSize: 14)),
                      ],
                    ),
                  ),
                ],
